...
class Scenario(object):
    ...
    def __init__(self, *initial_data, **kwargs):
        ...
        # Resource available times (not yet used)
        self.resource_shifts = {
            'human_sample_receipt': (0.0, 18.00),
            'human_sample_prep': (0.0, 18.00),
            'human_rna_prep': (0.0, 18.00),
            'human_pcr': (0.0, 18.00),
            'biomek': (0.0, 24.00),
            'pcr_plate_stamper': (0.0, 24.00),
            'pcr_plate_reader': (0.0, 24.00),
            'sample_prep_automation': (0.0, 24.00),
            }
